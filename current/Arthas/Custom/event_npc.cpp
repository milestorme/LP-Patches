...
#define FIRE_SAY_AGGRO                                "You have nothing to do here. Get out while you're alive!"
#define FIRE_SAY_FRENZY                               "Rage fills me!"
#define FIRE_SAY_SUMMON_TITAN                         "My servants, help me!"
#define FIRE_SAY_KILL                                 "It's all over!"
#define FIRE_SAY_DIE                                  "This time... you're lucky..."
           ...
           void EnterEvadeMode(EvadeReason) override
            ...
            void UpdateAI(const uint32 uiDiff)
            {
                ...
                if (m_uiPhase > 1)
                {
                    ...
                    {
                        me->Say(FIRE_SAY_FRENZY, LANG_UNIVERSAL, 0);
           ...
           void EnterEvadeMode(EvadeReason) override
            ...
            void UpdateAI(const uint32 uiDiff)
            {
                ...
                if (m_uiSummonSoulsTimer <= uiDiff)
                {
                    ...
                    me->Say(DARK_SAY_SUMMON, LANG_UNIVERSAL, 0);
                    m_uiSummonSoulsTimer = urand(12000,20000);
                }
                else
                ...
                if (dPhase == 1)
                {
                    ...
                    {
                        ++dPhase;
                        me->Say(DARK_SAY_FRENZY, LANG_UNIVERSAL, 0);
