...
public:
    ...
    struct bot_druid_ai : public bot_minion_ai
    {
        ...
        void JustDied(Unit* u) override { removeFeralForm(true, false); bot_minion_ai::JustDied(u); }
        ...
        void removeFeralForm(bool force = false, bool /*init*/ = true, uint32 diff = 0) override
        {
...
/*Misc*/float rageIncomeMult, rageLossMult;
  ...
  /*Talent*/LEADER_OF_THE_PACK_BUFF             = 24932,
            ...
            {
                return ::druid_bot::OnGossipHello(player, me);
            }
